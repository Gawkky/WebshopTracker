...
class PricetrackerDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
class FakeUserAgentMiddleware:
    ...
    def __init__(self, settings):
        ...
        self.scrapeops_endpoint = os.getenv('SCRAPEOPS_FAKE_USER_AGENT_ENDPOINT', 'https://headers.scrapeops.io/v1/user-agents?')
        self.scrapeops_fake_user_agents_active = os.getenv('SCRAPEOPS_FAKE_USER_AGENT_ENABLED', False),
